...
<body>
    ...
    <a class="navbar-brand col-9 ml-3"><span class="navWhiteHead">Murphy Cemetery</span></a>
    ...
    <div class="container lg-col-10 md-col-10 sm-col-12">

        <main>
            <img src="../public/images/contact.jpg" alt="murphy cemetery entrance">
        </main>
        ...
        <aside>
            ...
            <form method="POST" action="../public/contact.php">
                ...
                <div class="form-group col-10 m-auto">
                    ...
                    <input type="name" class="form-control" id="name" placeholder="Enter your name here" name="name"><span><?php echo $nameErrMsg; ?></span>
                </div>

                <div class="form-group col-10 m-auto">
                    <label for="email">Email:</label>
                    <input type="email" class="form-control" id="email" placeholder="Enter email" name="email"><span><?php echo $emailErrMsg; ?></span>
                </div>

                <div class="form-group col-10 m-auto">
                    <label for="message">Message: </label>
                    <textarea class="form-control" name="message" id="message" placeholder="Enter message here" name="message"></textarea><span><?php echo $messageErrMsg; ?></span>
                </div>
